...
# Xoá log lỗi cũ trước khi bắt đầu lượt chạy mới — extract_keyframes.py ghi APPEND vào file này
# (vì nhiều tiến trình song song bên dưới cùng ghi vào 1 file), nên phải xoá sạch ở đây để
# không lẫn lỗi của lần chạy trước.
rm -f "$DIR/data/keyframes/_failed_videos.txt"
